...
import net.chat.rest.DataResponse;
...
//        MDC.put(USER_SESSION_KEY, userValue);
    ...
    private void processUsernamePasswordAuthentication(HttpServletResponse httpResponse, Optional<String> username, Optional<String> password) throws IOException {
        ...
        String tokenJsonResponse = new ObjectMapper().writeValueAsString(DataResponse.success(resultOfAuthentication.getDetails().toString()));
